...
|-------|------|-----------|
| **Perception** | Signals in — how the system receives input | Codex, webhooks, chat channels (Telegram/WhatsApp/Discord), heartbeat/cron |
...
```
chronos/                             # Monorepo
├── .Codex/                         # Codex harness (primary today)
